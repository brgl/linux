...
static const struct msm_pingroup nord_groups[] = {
	...
	[121] = PINGROUP(121, qup0_se5, lbist_pass, mdp0_vsync4_out, _, dp_rx10, ddr_pxi7, _, _, _, _, _),
	[122] = PINGROUP(122, qup0_se5, mbist_pass, mdp0_vsync5_out, _, dp_rx11, ddr_pxi7, _, _, _, _, _),
	[123] = PINGROUP(123, qup1_se0, qup1_se1, mdp1_vsync0_out, jitter_bist, _, _, _, _, _, _, _),
	[124] = PINGROUP(124, qup1_se0, qup1_se1, mdp1_vsync1_out, _, _, _, _, _, _, _, _),
	[125] = PINGROUP(125, qup1_se1, qup1_se0, ccu_i2c_sda7, mdp1_vsync2_out, _, _, _, _, _, _, _),
	...
	[128] = PINGROUP(128, qup1_se2_l2, qup1_se2_l0, _, atest_usb20, ddr_pxi9, _, _, _, _, _, _),
	...
	[133] = PINGROUP(133, qup1_se5, emac0_ptp, mdp1_vsync8_out, _, ddr_pxi11, _, _, _, _, _, _),
	[134] = PINGROUP(134, qup1_se5, emac0_ptp, mdp1_vsync9_out, _, ddr_pxi12, _, _, _, _, _, _),
	[135] = PINGROUP(135, qup1_se5, emac0_ptp, mdp1_vsync10_out, _, ddr_pxi12, _, _, _, _, _, _),
	...
	[138] = PINGROUP(138, qup1_se6, qup1_se4, dp_rx0, qdss_cti, jitter_bist, ddr_pxi14, _, _, _, _, _),
	[139] = PINGROUP(139, qup2_se0, emac0_ptp, mdp0_vsync6_out, ddr_pxi14, _, _, _, _, _, _, _),
	...
	[143] = PINGROUP(143, qup2_se1, qup2_se4, ccu_timer10, mdp0_vsync10_out, _, _, _, _, _, _, _),
	[144] = PINGROUP(144, qup2_se1, qup2_se4, ccu_timer11, qdss_cti, mdp_vsync_s, _, _, _, _, _, _),
