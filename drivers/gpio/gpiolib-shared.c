...
/*
 * Special case: reset-gpio is is an auxiliary device that's created
 * dynamically and put in between the GPIO controller and consumers of shared
 * GPIOs referred to by the "reset-gpios" property.
 *
